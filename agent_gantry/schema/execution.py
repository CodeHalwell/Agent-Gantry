...
class ToolCall(BaseModel):
    ...
    _reject_newline_identifiers = field_validator("tool_name", "trace_id", "parent_span_id")(reject_newlines)
...
class ToolResult(BaseModel):
    ...
    _reject_newline_identifiers = field_validator("tool_name", "trace_id", "span_id")(reject_newlines)
