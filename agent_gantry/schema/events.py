...
class ExecutionEvent(BaseModel):
    ...
    _reject_newline_identifiers = field_validator("trace_id", "span_id", "tool_name")(reject_newlines)
...
class TokenUsageEvent(BaseModel):
    ...
    _reject_newline_identifiers = field_validator("model_name", "trace_id")(reject_newlines)
