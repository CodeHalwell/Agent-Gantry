...
- Version of record is `pyproject.toml` / `agent_gantry/__init__.py` `__version__` (currently `0.18.1`). The docs `package.json` and `README.md` may lag — `tests/test_version_consistency.py` guards consistency where it matters.
